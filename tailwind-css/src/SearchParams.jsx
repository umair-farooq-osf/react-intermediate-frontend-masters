...
const SearchParams = () => {
  ...
  return (
    <div className="my-0 mx-auto w-11/12">
      <form
        className="p-10 mb-10 rounded-lg shadow-lg bg-gray-200 flex flex-col items-center justify-center"
        onSubmit={(e) => {
          e.preventDefault();
      ...
      >
        ...
        <label htmlFor="location">
          Location
          <input type="text" id="location" name="location" placeholder="Location" className="w-60 mb-5 block" />
        </label>
